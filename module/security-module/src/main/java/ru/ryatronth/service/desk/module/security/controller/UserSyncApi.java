...
public interface UserSyncApi {
    ...
    @Operation(summary = "Синхронизировать пользователя", description = """
                                                                        ...
                                                                        """, responses = {
        @ApiResponse(responseCode = "200", description = "Пользователь успешно синхронизирован", content = @Content),
    ...
    @PostMapping("/sync")
    void syncUser(@Parameter(hidden = true, description = "JWT токен текущего пользователя") Jwt jwt);
